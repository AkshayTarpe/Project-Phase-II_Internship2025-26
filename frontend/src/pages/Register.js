...
function Register() {
  ...
  const sendOtpToEmail = async (emailToSend) => {
    const res = await axios.post(`${API_BASE}/api/auth/register/send-otp`, {
      email: emailToSend,
    });
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      await axios.post(`${API_BASE}/api/auth/register/verify-otp`, {
        email: trimmedEmail,
        otp: trimmedOtp,
      });
  ...
  return (
    <div className="auth-page">
            ...
            <div className="modal-overlay" onClick={() => setModal(null)}>
              <div className="modal-box terms-modal" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="modal-content">
                  <p><strong>1. Acceptance</strong><br />These Terms &amp; Conditions govern your use of Personal Carbon Tracker (the &quot;Service&quot;), a carbon footprint tracking application. By registering or using the Service, you agree to these terms.</p>
                  <p><strong>2. Description of Service</strong><br />Personal Carbon Tracker allows you to create an account, log in (via email/password or Google/GitHub), track your carbon-related activities, and view a personal dashboard. The Service includes features such as forgot-password (OTP by email when configured) and optional OAuth sign-in.</p>
          ...
          {modal === "privacy" && (
            <div className="modal-overlay" onClick={() => setModal(null)}>
              <div className="modal-box terms-modal" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="modal-content">
                  <p><strong>1. Introduction</strong><br />This Privacy Policy describes how Personal Carbon Tracker (&quot;we&quot;, &quot;our&quot;) collects, uses, and protects your personal data when you use our carbon footprint tracking application.</p>
      ...
      <footer className="auth-footer" style={{ textAlign: "center", padding: "1.5rem", color: "#666", fontSize: "0.875rem", marginTop: "auto", display: "flex", flexDirection: "column", alignItems: "center", gap: "4px" }}>
        <p style={{ margin: 0 }}>&copy; {new Date().getFullYear()} Personal Carbon Tracker. All rights reserved.</p>
      </footer>
    </div>
  );
}
