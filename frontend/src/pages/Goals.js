...
function Goals() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("personal-carbon-tracker-footprint-updated", onFootprintUpdated);
    return () =>
      window.removeEventListener("personal-carbon-tracker-footprint-updated", onFootprintUpdated);
  }, []);
