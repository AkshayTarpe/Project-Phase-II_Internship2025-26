...
public class EmailService {
    ...
    public boolean sendOtpEmail(String toEmail, String otp) {
        ...
        try {
            ...
            message.setSubject("Personal Carbon Tracker - Password reset OTP");
            message.setText(
    ...
    public boolean sendRegistrationOtpEmail(String toEmail, String otp) {
        ...
        try {
            ...
            message.setFrom(fromEmail);
            message.setTo(toEmail);
            message.setSubject("Personal Carbon Tracker - Verify your email");
            message.setText(
                "Your Personal Carbon Tracker registration code is: " + otp + "\n\n" +
                "This code is valid for 10 minutes.\n\n" +
    ...
    public boolean sendPlainTextEmail(String toEmail, String subject, String body) {
        ...
        try {
            ...
            message.setSubject(subject != null ? subject : "Personal Carbon Tracker");
