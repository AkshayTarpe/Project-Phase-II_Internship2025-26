...
public class AdminSettingsStoreService {
    ...
    private void ensureDefaults() {
        ...
        settingsStore.putIfAbsent("appName", "Personal Carbon Tracker");
        settingsStore.putIfAbsent("logoDataUrl", "");
        settingsStore.putIfAbsent("electricityFactor", 0.82);
        settingsStore.putIfAbsent("renewableEnergyMultiplier", 0.6);
        settingsStore.putIfAbsent("transportFactor", 0.12);
        settingsStore.putIfAbsent("transportBikeMultiplier", 0.2);
        settingsStore.putIfAbsent("transportCarPetrol", 0.21);
        settingsStore.putIfAbsent("transportCarDiesel", 0.18);
        settingsStore.putIfAbsent("transportCarElectric", 0.05);
        ...
        settingsStore.putIfAbsent("foodVeganMultiplier", 0.8);
